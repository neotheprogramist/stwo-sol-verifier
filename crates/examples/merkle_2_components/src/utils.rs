...
use stwo_prover::core::lookups::gkr_prover;
use stwo_prover::core::queries::QueriesWithBranching;
use stwo_prover::core::vcs::blake2_hash::Blake2sHash;
use stwo_prover::core::vcs::blake2_merkle::{Blake2sMerkleChannel, Blake2sMerkleHasher};
use stwo_prover::constraint_framework::{FrameworkComponent, InfoEvaluator, PREPROCESSED_TRACE_IDX, relation};
...
use stwo_prover::core::poly::circle::{CircleEvaluation, SecureCirclePoly};
...
pub fn verify_merkle(
    ...
    config: stwo_prover::core::pcs::PcsConfig,
    composition_polynomial: SecureCirclePoly<SimdBackend>,
) -> Result<(Blake2sHash, FrameworkComponent<MerkleComputingEval>, FrameworkComponent<MerkleSchedulerEval>, Vec<Blake2sHash>, Vec<Vec<u32>>, u32, (QueriesWithBranching, TreeVec<ColumnVec<u32>>), usize), Box<dyn std::error::Error>> { // digest, mask offsets for each component, roots, log sizes
  ...
  // Step 7: Verify the proof
    ...
    let queries_with_column_log_sizes = stwo_polynomial::verify::verify_with_queries(
        &[&component_computing, &component_scheduler],
        channel,
        commitment_scheme,
        proof.clone(),
  ...
  let components_vec: Vec<&dyn Component> = vec![
    ...
    Ok((digest, component_computing, component_scheduler, vec![proof.commitments[0], proof.commitments[1], proof.commitments[2]], extended_log_sizes, components_log_degree_bound, queries_with_column_log_sizes, n_preprocessed_columns))
}
